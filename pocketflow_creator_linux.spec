...
#
# PyInstaller spec for PocketFlow Creator — Linux one-file bundle.
#
# Usage:
#   pyinstaller pocketflow_creator_linux.spec
#
...
# Pull in PySide6 data (Qt plugins, translations, etc.)
