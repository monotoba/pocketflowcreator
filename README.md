...
**NEW:** 77 of 91+ node types now have standalone Python script generation. Export graphs as self-contained scripts with embedded providers and zero external dependencies.
...
- **91+ built-in node types** available in the visual palette with purpose-drawn icons across 28 categories:
  - *(77+ of these have complete standalone Python script generator support)*
